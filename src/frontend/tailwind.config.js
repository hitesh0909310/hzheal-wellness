    ...
    extend: {
      ...
      colors: {
        ...
        teal: {
          ...
          400: "oklch(0.82 0.10 192)",
          500: "oklch(0.74 0.12 192)",
        },
        gold: "oklch(var(--gold))",
      ...
      boxShadow: {
        ...
        glow: "0 0 24px oklch(0.74 0.12 192 / 0.25), 0 0 48px oklch(0.74 0.12 192 / 0.10)",
        card: "0 4px 32px oklch(0.10 0.03 280 / 0.6), 0 0 0 1px oklch(0.29 0.10 280 / 0.6)",
      },
      keyframes: {
        "accordion-down": { from: { height: "0" }, to: { height: "var(--radix-accordion-content-height)" } },
        "accordion-up": { from: { height: "var(--radix-accordion-content-height)" }, to: { height: "0" } },
        float: { "0%, 100%": { transform: "translateY(0px)" }, "50%": { transform: "translateY(-12px)" } },
        wave: { "0%": { transform: "scaleY(1)" }, "50%": { transform: "scaleY(0.4)" }, "100%": { transform: "scaleY(1)" } },
      },
      animation: {
